...
* @method DocumentFragment afterDocumentFragment(?callable $callback = null)
...
* @method DocumentFragment appendDocumentFragment(?callable $callback = null)
...
* @method DocumentFragment beforeDocumentFragment(?callable $callback = null)
...
* @method DocumentFragment prependDocumentFragment(?callable $callback = null)
...
* @method DocumentFragment replaceWithDocumentFragment(?callable $callback = null)
